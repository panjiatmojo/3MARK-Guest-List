jQuery(document).ready(function($) {
    ...
    function activateVisitorData() {
        ...
        $('#emgl-visitor-data-table table tbody tr').click(function() {
    ...
    function activateBlockedVisitorData() {
        ...
        $('#emgl-blocked-visitor-data-table table tbody tr').click(function() {
            showVisitorDetail(this);
        });
	...
	{
		var visitorDetail = $(selector).find('textarea[name=em-blocked-detail]').val();
    ...
    function showFloatingScreen(parameter) {
        ...
        var floatingScreen = "<div id=\"emgl-floating-screen\" style=\"width:100%;height:100%;position:fixed;top:0;bottom:0;right:0;left:0;z-index:100000;display:none;background:#000;opacity:.8;text-align:center;line-height:100%;\"></div>" +
            "<div id=\"emgl-floating-screen-wrapper\" style='overflow:hidden;position:fixed;top:0;bottom:0;right:0;left:0;margin:auto;width:80%;height:80%;background:#FFF;opacity:1;z-index:100001;'><div id=\"emgl-floating-screen-menu\" style=\"display:block;\"><div id=\"emgl-floating-screen-close\" style=\"position:absolute;right:20px;top:20px;height:30px;width:30px;background:#F64747;color:#FFF;text-align:center;line-height:30px;border-radius:15px;font-weight:bold;cursor:pointer;font-family:Verdana, Geneva, sans-serif\">X</div></div><div id=\"emgl-floating-screen-content\" style=\"margin:auto;width:96%;overflow:scroll;padding:2%;\">"+ content +"&nbsp;</div></div>";
